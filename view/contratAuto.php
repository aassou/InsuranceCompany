                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="../print/ContratAutoPrint.php?idContrat=<?= $contrat->id() ?>" target="_blank" class="btn mini blue" title="Imprimer Contrat"><i class="icon-print"></i></a>
                                                    <a href="automobile-update.php?idContrat=<?= $contrat->id() ?>" class="btn mini green" title="Modifier"><i class="icon-refresh"></i></a>
                                                ...
                                                <form class="form-horizontal" action="../app/Dispatcher.php" method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                <input type="hidden" name="idContratAuto" value="<?= $contrat->id() ?>" />
